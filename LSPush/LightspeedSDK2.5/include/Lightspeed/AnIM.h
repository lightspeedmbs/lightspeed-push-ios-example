...
@optional
// return the error with NSString
- (void)anIM:(AnIM *)anIM didGetClientId:(NSString *)clientId error:(NSString *)error __attribute__((deprecated));
- (void)anIM:(AnIM *)anIM didUpdateStatus:(BOOL)status error:(NSString *)error __attribute__((deprecated));

- (void)anIM:(AnIM *)anIM sendReturnedError:(NSString *)error messageId:(NSString *)messageId __attribute__((deprecated));
...
- (void)anIM:(AnIM *)anIM didReceiveMessage:(NSString *)message customData:(NSDictionary *)customData from:(NSString *)from parties:(NSSet *)parties messageId:(NSString *)messageId __attribute__((deprecated));
...
- (void)anIM:(AnIM *)anIM didReceiveBinary:(NSData *)data fileType:(NSString *)fileType customData:(NSDictionary *)customData from:(NSString *)from parties:(NSSet *)parties messageId:(NSString *)messageId __attribute__((deprecated));
...
- (void)anIM:(AnIM *)anIM didReceiveMessage:(NSString *)message customData:(NSDictionary *)customData from:(NSString *)from topicId:(NSString *)topicId messageId:(NSString *)messageId __attribute__((deprecated));
...
- (void)anIM:(AnIM *)anIM didReceiveBinary:(NSData *)data fileType:(NSString *)fileType customData:(NSDictionary *)customData from:(NSString *)from topicId:(NSString *)topicId messageId:(NSString *)messageId __attribute__((deprecated));
...
- (void)anIM:(AnIM *)anIM didReceiveNotice:(NSString *)notice customData:(NSDictionary *)customData from:(NSString *)from messageId:(NSString *)messageId __attribute__((deprecated));
...
- (void)anIM:(AnIM *)anIM didCreateTopic:(NSString *)topicId error:(NSString *)error __attribute__((deprecated));
- (void)anIM:(AnIM *)anIM didAddClients:(NSString *)error __attribute__((deprecated));
- (void)anIM:(AnIM *)anIM didRemoveClients:(NSString *)error __attribute__((deprecated));
- (void)anIM:(AnIM *)anIM didGetTopicInfo:(NSString *)topicId name:(NSString *)topicName parties:(NSSet *)parties createdDate:(NSDate *)createdDate error:(NSString *)error __attribute__((deprecated));
- (void)anIM:(AnIM *)anIM didGetTopicLog:(NSArray *)logs error:(NSString *)error __attribute__((deprecated));
- (void)anIM:(AnIM *)anIM didGetTopicList:(NSArray *)topics error:(NSString *)error __attribute__((deprecated));

- (void)anIM:(AnIM *)anIM didBindService:(NSString *)error __attribute__((deprecated));
- (void)anIM:(AnIM *)anIM didUnbindService:(NSString *)error __attribute__((deprecated));

- (void)anIM:(AnIM *)anIM didGetClientsStatus:(NSDictionary *)clientsStatus error:(NSString *)error __attribute__((deprecated));
- (void)anIM:(AnIM *)anIM didGetSessionInfo:(NSString *)sessionId parties:(NSSet *)parties error:(NSString *)error __attribute__((deprecated));
...
- (void)anIM:(AnIM *)anIM didGetTopicLog:(NSArray *)logs exception:(ArrownockException *)exception;
