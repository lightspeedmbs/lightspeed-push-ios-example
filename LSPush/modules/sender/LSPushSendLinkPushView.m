...
@interface LSPushSendLinkPushView () <UITextFieldDelegate>
...
@implementation LSPushSendLinkPushView
...
- (void)prepareSendLinkPushView
{
    ...
    if (!self.textInputField)
    {
        ...
        [textinputBaseview.layer setBorderColor:[UICommonUtility hexToColor:0xEA9C29 withAlpha:[NSNumber numberWithFloat:1.0f]].CGColor];
        ...
        self.textInputField.placeholder = @"http://www.example.com/";
    }
    ...
    if (!self.btnPush)
    {
        ...
        [self.btnPush setImage:[UIImage imageNamed:@"push_bu02_up.png"] forState:UIControlStateNormal];
        [self.btnPush setImage:[UIImage imageNamed:@"push_bu02_down.png"] forState:UIControlStateHighlighted];
        [self.btnPush setImage:[UIImage imageNamed:@"push_bu02_disable.png"] forState:UIControlStateDisabled];
